    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/rekapkehadiran" class="nav-link">
          ...
          <li class="nav-header">SPP</li>
          <li class="nav-item">
            <a href="/dataspp" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">@yield('judulhead')</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">@yield('deskripsiheader')</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              @yield('isi')
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">@yield('deskripsiheader2')</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              @yield('isi2')
